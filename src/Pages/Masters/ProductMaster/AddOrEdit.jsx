            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="number" {...register('division')} className={errors.division ? 'border-red-500' : ''} />
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="number" {...register('dimnesion')} className={errors.dimnesion ? 'border-red-500' : ''} />
                        {errors.dimnesion && <span className="text-sm text-red-500">{errors.dimnesion.message}</span>}
                    </div>

                    <div className="space-y-2">
                        <Label>Dimension Unit</Label>
                        <Input {...register('dimensionunit')} className={errors.dimensionunit ? 'border-red-500' : ''} />
                        {errors.dimensionunit && <span className="text-sm text-red-500">{errors.dimensionunit.message}</span>}
                    </div>

                    <div className="space-y-2">
                        <Label>Unit Weight</Label>
                        <Input type="number" {...register('dimunitwt')} className={errors.dimunitwt ? 'border-red-500' : ''} />
                    ...
                    <div className="space-y-2">
                        ...
                        <Input type="number" {...register('l1netwt')} className={errors.l1netwt ? 'border-red-500' : ''} />
                        {errors.l1netwt && <span className="text-sm text-red-500">{errors.l1netwt.message}</span>}
                    </div>

                    <div className="space-y-2">
                        <Label>No. of L2</Label>
                        <Input type="number" {...register('noofl2')} className={errors.noofl2 ? 'border-red-500' : ''} />
                        {errors.noofl2 && <span className="text-sm text-red-500">{errors.noofl2.message}</span>}
                    </div>

                    <div className="space-y-2">
                        <Label>No. of L3/L2</Label>
                        <Input type="number" {...register('noofl3perl2')} className={errors.noofl3perl2 ? 'border-red-500' : ''} />
                        {errors.noofl3perl2 && <span className="text-sm text-red-500">{errors.noofl3perl2.message}</span>}
                    </div>

                    <div className="space-y-2">
                        <Label>No. of L3/L1</Label>
                        <Input type="number" {...register('noofl3perl1')} className={errors.noofl3perl1 ? 'border-red-500' : ''} />
                        {errors.noofl3perl1 && <span className="text-sm text-red-500">{errors.noofl3perl1.message}</span>}
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        {errors.scannerdealy && <span className="text-sm text-red-500">{errors.scannerdealy.message}</span>}
                    </div>

                    <div className="space-y-2">
                        <Label>Printer Delay</Label>
                        <Input {...register('printerdealy')} className={errors.printerdealy ? 'border-red-500' : ''} />
                        {errors.printerdealy && <span className="text-sm text-red-500">{errors.printerdealy.message}</span>}
                    </div>
