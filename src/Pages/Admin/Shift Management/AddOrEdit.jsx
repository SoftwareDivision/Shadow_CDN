...
function AddOrEdit() {
    ...
    // useEffect(() => {
    //     if (isEdit && shiftManagementData) {
    //         const shiftArray = shiftManagementData.shift?.split(',') || [];
    //         console.log("Shifts loaded for edit:", shiftArray); // 👈 DEBUG HERE
    //         reset({
    //             pname: shiftManagementData.pname,
    //             pcode: shiftManagementData.pcode,
    //             shift: shiftArray,
    ...
    //         });
    //     }
    // }, [isEdit, shiftManagementData, reset]);
    ...
    useEffect(() => {
        if (shiftData) {
            ...
            if (isEdit && shiftManagementData) {
                ...
                console.log("Shifts loaded for edit:", validShiftValues);
                setValue('shift', validShiftValues); // Ensure it sets only matching values
            }
        }
    ...
    const mutation = useMutation({
        mutationFn: (formData) => {
            ...
            return isEdit
                ? updateShiftManagement(tokendata, payload)
                : createShiftManagement(tokendata, payload);
        },
        onSuccess: () => {
                        ...
                        render={({ field }) => (
                            <div>
                                ...
                                <MultiSelect
                                    ...
                                    variant="inverted"
                                />
                                {errors.shift && <span className="text-red-500 text-sm">{errors.shift.message}</span>}
                            </div>
                        )}
                    />
