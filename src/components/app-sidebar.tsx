...
import { ReceiptText, BookOpen, Bot, ChartArea, Command, Database, Frame, GalleryVerticalEnd, LucideIcon, LucideTruck, Map, MessageCircle, MessageCircleDashed, PieChart, Settings2, SquareTerminal, Store, Workflow, FileSpreadsheet, PrinterIcon, ShieldUser, ChevronRight, Home, } from "lucide-react";

import { Sidebar, SidebarContent, SidebarFooter, SidebarHeader, SidebarRail, SidebarGroup, SidebarGroupLabel, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, } from "@/components/ui/sidebar";
